          ...
          <div className='main mb-3'>
            ...
            <div className='row'>
              <div className='col-md-12'>
                ...
                {/* <textarea class="desc ft-14 p-1 form-control" name="rule_description" placeholder="Enter your description here" rows="4" cols="50">This is a default description for the Leave Type. You can customise this. </textarea> */}
              </div>
            </div>
          </div>
          <hr />
